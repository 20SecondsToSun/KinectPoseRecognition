...
//std::vector<ci::gl::Texture> Params::_successComics(2);
...
//void Params::saveBufferSuccessComics(const ci::gl::Texture& tex, int index)
//{
//	_successComics[index] = tex;	
//}
//
//std::vector<ci::gl::Texture> Params::getBufferSuccessComics()
//{
