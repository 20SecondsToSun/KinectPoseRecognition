...
float fabs(const ci::Vec2f& v);


/**************************** 2D Spline (of ofxVec2) ****************************/
class ofxMSASpline2D : public ofxMSASpline<ci::Vec2f> {
public:
	...
	std::vector<ci::Vec2f> getPoints(int numSteps) 
	{
